...
class Track(models.Model):
    ...
    track_id = models.CharField(max_length=264, unique=True, default=uuid.uuid4)

    def __str__(self):
        return self.trackname

class Topic(models.Model):
    topic_id = models.CharField(max_length=264, unique=True, default=uuid.uuid4)
...
class Quiz(models.Model):
    question_id = models.CharField(max_length=264, unique=True, default=uuid.uuid4)
